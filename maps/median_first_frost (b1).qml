...
<qgis version="3.38.0-Grenoble" styleCategories="Symbology">
  ...
  <pipe>
    ...
    <rasterrenderer classificationMax="335" band="1" alphaBand="-1" opacity="1" classificationMin="0" nodataColor="122,4,3,0,rgb:0.47843137254901963,0.01568627450980392,0.01176470588235294,0" type="singlebandpseudocolor">
      <rasterTransparency/>
      <minMaxOrigin>
        <limits>None</limits>
